...
export const VerificationBlock: FC<VerificationBlockProps> = ({ step, isVerified, index }: VerificationBlockProps) => {
    const { theme } = useThemeContext();
    const styles = useMemo(() => verificationBlockStyles(theme), [theme]);

    return (
        <Pressable
            style={[styles.container, checkIndexIsEven(index) && styles.containerWithMargin]}
