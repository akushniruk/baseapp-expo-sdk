...
export const ProfileDetails: FC = () => {
    ...
    const redirectToVerificationCenter = useCallback(() => {
        ...
        process.env.REACT_APP_MODE !== "storybook" && linkTo("/VerificationCenter");
    }, []);
    ...
    const renderVerificationBlock = useMemo(() => {
        return kycSteps.map((step: string, index: number) => {
            ...
            return <VerificationBlock key={step} index={index} isVerified={!!isVerified} step={step} />;
        });
    }, []);
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.verificationContainer}>
                <Pressable onPress={redirectToVerificationCenter} style={styles.verificationContainerBlock}>
                    <View>
